...
class Particle:
    ...
    def __init__(self):
        self.particleImg = pygame.image.load(os.path.join(os.path.dirname(__file__), 'images/food.png'))
    ...
    def show_close(self):                   #testing function
        screen.blit(pygame.image.load(os.path.join(os.path.dirname(__file__), "images/food_near.png")), (self.particleX, self.particleY))
